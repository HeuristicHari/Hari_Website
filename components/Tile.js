...
const Tile = ({ title, content, link,bg }) => {
  return (
    ...
    : "bg-orange-300 sm:w-48 lg:w-80 sm:h-48 lg:h-80 rounded-lg overflow-hidden shadow-md mx-4 my-4 hover:shadow-lg transform hover:scale-110 transition duration-300" }>  
